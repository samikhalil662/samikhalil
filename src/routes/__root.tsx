...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Muhammad Sami — AI Developer" },
      { name: "description", content: "Portfolio of Muhammad Sami, AI developer building ML models, LLM agents, and automation." },
      { name: "author", content: "Muhammad Sami" },
      { property: "og:title", content: "Muhammad Sami — AI Developer" },
      { property: "og:description", content: "Portfolio of Muhammad Sami, AI developer building ML models, LLM agents, and automation." },
